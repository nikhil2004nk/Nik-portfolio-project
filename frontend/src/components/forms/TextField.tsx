  ...
  return (
    <div className="space-y-2">
      ...
      <input
        {...registration}
        {...props}
        className={`w-full bg-ink border rounded-md px-4 py-3 text-primary focus:outline-none focus:ring-2 focus:ring-signal focus:border-signal transition-all duration-150 ${
